...
import { allSleepInfo } from './testData';
...
describe("User Sleep", () => {
  ...
  it("Should have a method that returns how many hours a user slept over the course of a given week", () => {
  ...
  it("Should have a method that returns the sleep quality of a user over the course of a given week", () => {
